...
if(NOT DEFINED GLTF_SAMPLE_MODELS_DOWNLOAD_TIMEOUT_SECONDS)
    set(GLTF_SAMPLE_MODELS_DOWNLOAD_TIMEOUT_SECONDS "900")
endif()

if(NOT GLTF_SAMPLE_MODELS_DOWNLOAD_TIMEOUT_SECONDS MATCHES "^[1-9][0-9]*$")
    message(FATAL_ERROR "GLTF_SAMPLE_MODELS_DOWNLOAD_TIMEOUT_SECONDS must be a positive integer.")
endif()

if(NOT DEFINED GLTF_SAMPLE_MODELS_INACTIVITY_TIMEOUT_SECONDS)
    set(GLTF_SAMPLE_MODELS_INACTIVITY_TIMEOUT_SECONDS "60")
endif()

if(NOT GLTF_SAMPLE_MODELS_INACTIVITY_TIMEOUT_SECONDS MATCHES "^[1-9][0-9]*$")
    message(FATAL_ERROR "GLTF_SAMPLE_MODELS_INACTIVITY_TIMEOUT_SECONDS must be a positive integer.")
endif()
...
file(DOWNLOAD
    ...
    LOG download_log
    TLS_VERIFY ON
    TIMEOUT "${GLTF_SAMPLE_MODELS_DOWNLOAD_TIMEOUT_SECONDS}"
    INACTIVITY_TIMEOUT "${GLTF_SAMPLE_MODELS_INACTIVITY_TIMEOUT_SECONDS}"
    SHOW_PROGRESS
